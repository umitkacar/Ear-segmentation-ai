...
from earsegmentationai.preprocessing.transforms import BatchTransform, ImageTransform
...
class EarPredictor:
    ...
    def predict(
        ...
        try:
            ...
            probability_map = self._resize_mask(probability_map, original_shape)
    ...
    def predict_batch(
        ...
        try:
            ...
            for i in range(0, len(images), batch_size):
                ...
                batch_results = self._predict_batch(batch_images, return_probability)
    ...
    def _predict_batch(
        ...
        for i, output in enumerate(outputs):
            ...
            # Resize to original shape
            probability_map = self._resize_mask(probability_map, original_shapes[i])
    ...
    def warmup(self, input_shape: Optional[Tuple[int, int]] = None) -> None:
        ...
        try:
            ...
            if input_shape is None:
                input_shape = (config.processing.input_size[1], config.processing.input_size[0])
    ...
    def predict_frame(
        ...
        if return_probability:
            ...
            if self.smooth_masks and self.last_probability is not None:
                ...
                probability = alpha * probability + (1 - alpha) * self.last_probability
