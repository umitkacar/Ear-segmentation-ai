...
def test_legacy_imports():
    ...
    try:
        ...
        print(f"✓ EarModel imported")
        print(f"✓ ENCODER_NAME: {ENCODER_NAME}")
        print(f"✓ MODEL_NAME: {MODEL_NAME}")
        
        # Test legacy functions
        from earsegmentationai import process_camera_mode, process_image_mode
        print(f"✓ Legacy functions imported")
...
def test_legacy_cli_commands():
    ...
    legacy_commands = [
        ["python", "-m", "earsegmentationai.cli.app", "picture-capture", "--help"],
        ["python", "-m", "earsegmentationai.cli.app", "video-capture", "--help"],
        ["python", "-m", "earsegmentationai.cli.app", "webcam-capture", "--help"],
    ]
    ...
    with warnings.catch_warnings():
        ...
        try:
            ...
            if mask_v1.shape == mask_v2.shape:
                ...
                print(f"❌ Shape mismatch: v1={mask_v1.shape}, v2={mask_v2.shape}")
                return False
