...
class TestCLIIntegration:
    ...
    def test_download_model_command(self, runner, temp_dir, monkeypatch):
        ...
        with patch(
            "earsegmentationai.core.model.ModelManager",
    ...
    def test_process_image_single_file(
        self, runner, sample_image_files, temp_dir
    ):
        ...
        with patch(
            "earsegmentationai.cli.app.ImageProcessor"
        ) as mock_processor:
    ...
    def test_process_image_directory(
        self, runner, sample_image_files, temp_dir
    ):
    ...
    def test_process_video_command(self, runner, sample_video_file):
        ...
        with patch(
            "earsegmentationai.cli.app.VideoProcessor"
        ) as mock_processor:
            mock_instance = mock_processor.return_value
    ...
    def test_benchmark_command(self, runner, sample_image_files):
        ...
        with patch(
            ...
            with patch(
                "cv2.imread",
                return_value=np.ones((256, 256, 3), dtype=np.uint8),
            ):
                result = runner.invoke(
                    app,
                    [
    ...
    def test_error_handling_invalid_file(self, runner):
        ...
        result = runner.invoke(app, ["process-image", "non_existent_file.jpg"])
    ...
    def test_backward_compatibility_aliases(self, runner):
        ...
        for cmd in cmds:
            ...
            assert result.exit_code in [
                0,
                2,
            ]  # 0 for help, 2 for missing required args
