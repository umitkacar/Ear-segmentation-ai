...
class TestImageProcessorIntegration:
    ...
    def test_process_single_image_file(self, sample_image_files, mock_model_manager):
    ...
    def test_process_list_of_images(self, sample_image_files, test_image, mock_model_manager):
    ...
    def test_save_batch_results(self, sample_image_files, temp_dir, mock_model_manager):
    ...
    def test_error_handling_empty_directory(self, temp_dir, mock_model_manager):
    ...
    def test_batch_result_methods(self, sample_image_files, mock_model_manager):
