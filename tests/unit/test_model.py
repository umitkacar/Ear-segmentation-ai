...
class TestModelManager:
    ...
    def test_device_selection_cpu(self, test_config):
        ...
        with patch('earsegmentationai.core.model.get_config', return_value=test_config):
    ...
    def test_download_model_failure(self, mock_get, test_config, temp_dir):
        ...
        with patch('earsegmentationai.core.model.get_config', return_value=test_config):
            ...
            with pytest.raises(ModelLoadError, match="Failed to download model"):
                manager._download_model("http://example.com/model.pth", model_path)
    ...
    def test_clear_cache_gpu(self, mock_cuda_available, mock_empty_cache, test_config):
